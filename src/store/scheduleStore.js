...
export const useScheduleStore = create((set, get) => ({
  ...
  activePersonnelStudentId: null,
  activePersonnelTeacherId: null,
  
  setActiveModule: (module) => set({ activeModule: module }),
  setPersonnelTab: (tab) => set({ personnelTab: tab }),
  setActivePersonnelStudent: (id) => set({ activePersonnelStudentId: id }),
  setActivePersonnelTeacher: (id) => set({ activePersonnelTeacherId: id }),
  ...
  setActiveTab: (tab) => set({ activeTab: tab, activeModule: 'schedule' }),
  setActiveStudent: (id) => {
